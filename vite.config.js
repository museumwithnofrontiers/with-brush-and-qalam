...
// `...defineViewerConfig({ dataPackage: '@museumwnf/with-brush-and-qalam-data', plugins: [vue()] })`
  ...
  resolve: {
    alias: {
      ...
      '@inventory-data': fileURLToPath(
        new URL('./node_modules/@museumwnf/with-brush-and-qalam-data', import.meta.url),
      ),
    },
  },
  optimizeDeps: {
