...
The **Museum With No Frontiers — With Brush and Qalam** exhibition, built from the published
dataset `@museumwnf/with-brush-and-qalam-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/with-brush-and-qalam-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/with-brush-and-qalam/> through the reusable workflows in
